...
<div class="wrap">
	...
	<h1><?php esc_html_e( "Carbon Copy Options", 'carbon-copy' ); ?></h1>
...
<label>
<input type="checkbox" name="carbon_copy_copyattachments" value="1" <?php if( get_option( 'carbon_copy_copyattachments' ) == 1 ) echo 'checked="checked"'; ?> /><?php esc_html_e("Attachments", 'carbon-copy'); ?>
 <span class="description">(<em><?php esc_html_e("leave unchecked, unless you need special requirements", 'carbon-copy'); ?></em>)</span>
</label><br />
<label>
<input type="checkbox" name="carbon_copy_copychildren" value="1" <?php if( get_option( 'carbon_copy_copychildren' ) == 1 ) echo 'checked="checked"'; ?> /><?php esc_html_e("Children", 'carbon-copy'); ?>
</label><br />
<label>
<input type="checkbox" name="carbon_copy_copycomments" value="1" <?php if( get_option( 'carbon_copy_copycomments' ) == 1 ) echo 'checked="checked"'; ?> /><?php esc_html_e("Comments", 'default'); ?>
 <span class="description">(<em><?php esc_html_e("except pingbacks and trackbacks", 'carbon-copy'); ?></em>)</span>
</label><br />
<label>
...
?>
	...
	<span class="description"><?php esc_html_e("Select post types to be enabled. Custom Post Types might not display here as they are dependent upon your Theme or Plugin.", 'carbon-copy'); ?></span><br />
	<br />
	...
	<tr valign="top">
		<th scope="row">
			<label for="carbon_copy_title_prefix">
				<?php esc_html_e("Title prefix", 'carbon-copy'); ?>
			</label>
		</th>
		<td>
			...
			<span class="description"><?php esc_html_e("For example; \"Copy of\" (leave blank for no prefix)", 'carbon-copy'); ?></span>
		</td>
	</tr>
	<tr valign="top">
		<th scope="row">
			<label for="carbon_copy_title_suffix">
				<?php esc_html_e("Title suffix", 'carbon-copy'); ?>
			</label>
		</th>
		<td>
			...
			<span class="description"><?php esc_html_e("For example; \"Copy\" (leave blank for no suffix)", 'carbon-copy'); ?></span>
		</td>
	</tr>
	<tr valign="top">
		<th scope="row">
			<label for="carbon_copy_increase_menu_order_by">
				<?php esc_html_e("Menu order increase", 'carbon-copy'); ?>
			</label>
		</th>
		<td>
			...
			<span class="description"><?php esc_html_e("Add number to original menu order (leave blank/zero to retain value)", 'carbon-copy'); ?></span>
		</td>
	</tr>
	<tr valign="top">
		<th scope="row">
			<label for="carbon_copy_blacklist">
				<?php esc_html_e("Meta Field Exclusion List", 'carbon-copy'); ?>
			</label>
		</th>
		<td id="textfield">
			...
			<span class="description"><?php esc_html_e("Comma-separate list, use * to match zero or more alphanumeric characters or underscores: ex. field*", 'carbon-copy'); ?></span>
		</td>
	</tr>
</table>
...
<label>
	<input type="checkbox" name="carbon_copy_show_row" value="1" <?php if( get_option( 'carbon_copy_show_row' ) == 1 ) echo 'checked="checked"'; ?> /><?php esc_html_e("Post list", 'carbon-copy'); ?>
</label><br />
<label>
...
<label>
	<input type="checkbox" name="carbon_copy_show_original_meta_box" value="1" <?php if( get_option( 'carbon_copy_show_original_meta_box' ) == 1 ) echo 'checked="checked"'; ?> /><?php esc_html_e("In a metabox on the Edit screen [Classic editor]", 'carbon-copy'); ?>
	<span class="description">(<?php esc_html_e("You will also be able to delete the reference to the original item with a checkbox.", 'carbon-copy');  ?>)</span>
</label><br />
<label>
	<input type="checkbox" name="carbon_copy_show_original_column" value="1" <?php if( get_option( 'carbon_copy_show_original_column' ) == 1 ) echo 'checked="checked"'; ?> /><?php esc_html_e("In a column in the Post list", 'carbon-copy'); ?>
	<span class="description">(<?php esc_html_e("You will also be able to delete the reference to the original item with a checkbox in Quick Edit.", 'carbon-copy');  ?>)</span>
</label><br />
<label>
